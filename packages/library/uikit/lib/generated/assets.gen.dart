...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/img_muslimate_logo.png
...
class $AssetsL10nGen {
  ...
  String get appEn => 'packages/uikit/assets/l10n/app_en.arb';

  /// File path: assets/l10n/app_id.arb
  String get appId => 'packages/uikit/assets/l10n/app_id.arb';

  /// List of all assets
  List<String> get values => [appEn, appId];
}
